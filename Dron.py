...
class Dron(object):
    ...
    from functions_v0.geofence import clear_GEOFence, upload_GEOFence, command_long_send, clear_Mission, prepare_geofence, set_geofence, set_geofence_MAVLINK, geofence_trigger
    from functions_v0.modify_parameters import modify_parameter, get_parameter, modify_parameter_MAVLINK, get_parameter_MAVLINK
