...
from AutopilotServiceDEE_DCM.AutopilotServiceDEE_DCM.functions_v0.get_telemetry_info_v0_func import get_telemetry_info
...
def send_telemetry_info_v0(external_client, internal_client, sending_topic):
    ...
    while AutopilotServiceDEE_DCM.AutopilotServiceDEE_DCM.functions_v0.variables.sending_telemetry_info:
